<template>
    ...
    >
        ...
        <template v-else>
            <i :style="{backgroundColor: colorDark('bg-subtle'), borderColor: color('border-subtle')}" class="fa-solid  fa-minus border border-2 px-2 py-2 rounded-start-pill" role="button" @click="remove"></i>
            ...
            <i :style="{backgroundColor: colorDark('bg-subtle'), borderColor: color('border-subtle')}" class="fa-solid fa-plus border border-2 px-2 py-2 rounded-end-pill" role="button" @click="add"></i>
        </template>
    </div>
</template>
